    ...
    for t in range(7):
        ...
        for s in range(20):
            ...
            bps = [BrownianParticle(Config,
                                    Config.env_tuple[1]/2,
                                    Config.env_tuple[3]/2) 
            ...
            plt.colorbar()
            plt.savefig(f'avgp_hist{Config.env_tuple[1]*100}_{Config.N}_{Config.sigma}.png')
            plt.close()
            ...
            print(f'T={Config.T} N={Config.N} Sigma={Config.sigma} Took:{time.time()-st}')
        ...
        Config.T += Config.TNStep
        Config.N += Config.TNStep
